...
robot.write(r'\\10.1.2.47\d$\CSV\M\DN\PM\MRP108F')
robot.press('enter')
robot.press('enter')
...
# convert .xls to .cvs
read_file = pd.read_excel(r'\\10.1.2.47\d$\CSV\M\DN\PM\MRP108F.xls', 'MRP108F')
read_file.to_csv (r'\\10.1.2.47\d$\CSV\M\DN\PM\MRP108F.csv', index=False, sep=';')