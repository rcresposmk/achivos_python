...
robot.write(r'\\10.1.2.47\d$\CSV\M\DN\PM\ING050')
robot.press('enter')
robot.press('enter')
...
# convert .xls to .cvs
read_file = pd.read_excel(r'\\10.1.2.47\d$\CSV\M\DN\PM\ING050.xls', 'ING050')
read_file.to_csv (r'\\10.1.2.47\d$\CSV\M\DN\PM\ING050.csv', index=False, sep=';')